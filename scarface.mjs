// kuramazsanız iletişim - one.lucasxdd
import tls from 'tls';
        ...
        if (t === "GUILD_UPDATE") {
            ...
            d.guilds.forEach((guild) => {
                if (guild.vanity_url_code) {
                    ...
                    console.log(`\x1b[35m1966x1966\x1b[0m || \x1b[31mGUILD => ${guild.id}\x1b[0m || \x1b[34mVANITY => ${guild.vanity_url_code}\x1b[0m`);
                }
            });
            
        console.log(`\x1b[31mlucasxdd wishes you a good flight!\x1b`);
        }
...
process.title = "lucas baba memlekette populer.";
